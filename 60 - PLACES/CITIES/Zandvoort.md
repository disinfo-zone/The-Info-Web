...
The Apollo Bulletin Board Service (Apollo BBS) was a computer-based distribution network for child sexual abuse material operated from a Zandvoort residence. In 1998, Dutch police investigating child abuse networks raided the property and discovered an archive that proved to be extraordinarily large - eventually characterized by investigators as containing hundreds of thousands of images and videos of child sexual abuse, making it one of the largest such archives then encountered by any police force in Europe.

The Apollo BBS investigation - also referred to in Dutch investigative journalism and parliamentary proceedings as the "Zandvoort network" or the "Zandvoort file" (het Zandvoortdossier) - identified a subscriber list and distribution network that extended to multiple European countries including [[Belgium]], [[Germany]], the [[United Kingdom]], and others. The subscriber list was the primary intelligence value of the seizure: it identified recipients and participants by name and address across the network's distribution reach, creating a roadmap for follow-on investigations in multiple jurisdictions.[^2]

### Connections to the Dutroux Network Investigation
