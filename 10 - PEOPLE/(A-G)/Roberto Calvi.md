...
The offshore company network served multiple purposes. It allowed Banco Ambrosiano to make loans that did not appear on its Italian balance sheet, evading Banca d'Italia oversight. It provided a mechanism for moving funds out of Italy in violation of Italian currency controls. And it created vehicles through which politically sensitive transactions - including alleged funding of the [[Solidarity (Poland)|Solidarity]] trade union movement in Poland, facilitated partly through Vatican connections and partly through [[BCCI]] - could be conducted without direct Italian banking involvement.[^2]
