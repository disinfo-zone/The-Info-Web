...
8VC and Lonsdale are early and continuing backers of Anduril Industries, the defense contractor founded by [[Palmer Luckey]] with Founders Fund backing, which builds autonomous systems, surveillance platforms, and battlefield software for the Department of Defense and allied militaries. Anduril's rapid scaling during the second [[Donald Trump|Trump]] administration was the visible success case for the Thiel-network argument that the Pentagon should procure from [[Silicon Valley]]-style software firms rather than from the traditional defense primes ([[Lockheed Martin]], [[Raytheon]], [[Northrop Grumman]]).[^1]
