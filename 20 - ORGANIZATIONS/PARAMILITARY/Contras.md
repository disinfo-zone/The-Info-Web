...
The largest and best-equipped faction was the [[FDN|Fuerza Democrática Nicaragüense (FDN)]], created by the CIA, based in [[Honduras]], and commanded by [[Enrique Bermudez|Enrique Bermúdez]].[^2] The [[UDN-FARN]] was based in [[Costa Rica]] and commanded by [[Fernando Chamorro|"El Negro" Chamorro]]. [[ARDE]] was commanded by former Sandinista hero [[Eden Pastora|"Commandante Zero"]] and was also based in Costa Rica. The later umbrella group [[UNO]] was a CIA-inspired attempt to unite all factions under one banner.
