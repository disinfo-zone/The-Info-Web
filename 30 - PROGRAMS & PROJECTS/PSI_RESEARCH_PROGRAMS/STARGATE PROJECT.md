...
Key results under SCANATE included [[Pat Price]]'s 1974 viewing of the Soviet weapons research facility at Semipalatinsk (URDF-3), which CIA analysts assessed as substantially accurate against satellite imagery - Price described a gantry crane, spherical objects under construction, and unusual welding techniques consistent with imagery. Price's subsequent viewing of a secret [[National Security Agency|NSA]] signals intelligence facility at Sugar Grove, West Virginia, triggered an NSA security investigation of SRI that established the researchers had acted without foreknowledge of the site. SRI researchers [[Russell Targ]] and Puthoff published a 1974 paper in *Nature* and a 1976 paper in *Proceedings of the IEEE* documenting experimental results.[^1][^2]

### Establishment at Fort Meade

In 1977, Army captain [[Frederick Atwater|Frederick "Skip" Atwater]], assigned to the [[Systems Exploitation Detachment]] (SED) at Fort Meade, proposed an Army remote viewing program to Colonel [[Robert Keenan]]. The proposal was approved by Major General [[Edmund Thompson]]. Atwater and Major [[Murray Watt|Murray "Scotty" Watt]] visited SRI to understand viewer selection criteria, learning that Puthoff and Targ prioritized visual-spatial intelligence and artistic rendering ability over claimed psychic experience.
...
The final designation STAR GATE followed the transfer of most contracting from SRI to [[Science Applications International Corporation]] (SAIC) in 1991. May ran the program from SAIC's facilities in Menlo Park, California, maintaining a small operational unit at Fort Meade separately under DIA management.[^1][^3]
...
- [[Frederick Atwater|Skip Atwater]] - SED operations officer, recruited original viewers, later president of the [[Monroe Institute]]
- [[Albert Stubblebine]] - INSCOM commander 1981-1984, program's strongest command-level supporter
- [[Murray Watt|Murray "Scotty" Watt]] - first commanding officer of the remote viewing unit
...
- [[Stanford Research Institute]] - primary civilian contractor 1972-1991
- [[Science Applications International Corporation]] (SAIC) - took over most contracting 1991-1995
- [[Defense Intelligence Agency]] - primary government sponsor through the Sun Streak and STAR GATE phases
- [[Systems Exploitation Detachment]] - the Army unit that housed the program at Fort Meade
- [[United States Army Intelligence and Security Command]] (INSCOM) - parent command
- [[Monroe Institute]] - consciousness exploration organization; several program personnel affiliated, including Atwater and McMoneagle (who married into the Monroe family)
- [[American Institutes for Research]] - conducted the 1995 termination evaluation
- [[Institute of Noetic Sciences]] - funded Geller's SRI visit; separately funded parapsychology research
- [[American Society for Psychical Research]] - Swann was a research subject at ASPR before SRI
