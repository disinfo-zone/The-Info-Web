...
The Korean War produced the first systematic American encounter with sustained ideological-political prisoner handling, as distinct from the more purely physical coercion of earlier conflicts. Chinese and North Korean captors combined physical deprivation with sustained psychological manipulation, group pressure, and progressive demands for compliance, producing collaboration rates and public confessions that alarmed the US military establishment. The term [[Brainwashing|brainwashing]] entered public vocabulary in this period largely as a description of these techniques.[^1]
