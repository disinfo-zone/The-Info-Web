...
Fantasy themes from The Wizard of Oz, Disney films, Alice in Wonderland, and Cinderella were reportedly used as programming frameworks. A concept called the "Presidential Model" designated certain subjects for use exclusively by those of highest authority. Those designated as Presidential Models were allegedly used for sexual purposes, diplomatic message delivery, and other tasks by figures in the [[CIA]], [[Defense Intelligence Agency|DIA]], [[NSA]], and other security agencies.[^1]
