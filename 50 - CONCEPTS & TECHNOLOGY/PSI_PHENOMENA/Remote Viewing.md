...
SRI's written protocol of November 1978, by Puthoff and Targ, and its revision of August 1979, by Puthoff, Targ and [[Edwin May]], both in the CIA's files, set out the local-target procedure: a pool of more than fifty Bay Area sites chosen "by an experimenter who will not interact with the subject after that," a target drawn by "a Texas Instruments SR-51 hand calculator," a fifteen-minute viewing in "an isolated windowless room of the Radio Physics Laboratory" while an outbound person stood at the site, an "inbound experimenter" whose task was "to make it 'safe' for the subject to experience remote viewing" ("no hypnosis, strobe lights, or sensory-deprivation procedures are ever used"), feedback at the site "for each experiment to ensure success," and judging by "an SRI research analyst not otherwise associated with the series," who ranked each transcript against each site in a 6x6 matrix scored by "a direct-count-of-permutations method" that, the authors wrote, applied "even in the limiting case in which the target pool is completely known a priori to all involved."[^902]
...
David Marks and [[Richard Kammann]]'s Nature letter of August 17, 1978, reported that duplicate experiments at the [[University of Otago]] "do not verify their conclusions" and attributed the Price matches to cues in the transcripts; Puthoff, Targ and Charles Tart's reply, drafted in January 1979 and printed in 1980, reported a rejudging of edited transcripts; Marks returned to the argument in Nature in 1981 and, with Christopher Scott, in 1986, and in the [[Skeptical Inquirer]] in 1982: "Well-controlled experiments never find the RV effect, while poorly controlled experiments nearly always do." A separate evaluation of 1979 by Harry and Arlene Snyder of Blacksburg, Virginia, held by the CIA, reached similar conclusions on methodology without citing Marks and Kammann.[^901]
